...
gcoord(1)=0.0;  gcoord(2)=0.6;  gcoord(3)=1.2;  gcoord(4)=1.8;
gcoord(5)=2.4;  gcoord(6)=3;  
...
bcoef=1;               % coefficient 'b' of the diff eqn
